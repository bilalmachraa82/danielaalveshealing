...
export default function ClientEdit() {
  ...
  useEffect(() => {
    ...
    form.reset({
      ...
      consent_health_data: client.consent_health_data ?? false,
      service_consent_email: client.service_consent_email ?? false,
      service_consent_sms: client.service_consent_sms ?? false,
      service_consent_whatsapp: client.service_consent_whatsapp ?? false,
      consent_marketing: client.consent_marketing ?? false,
      marketing_consent_email: client.marketing_consent_email ?? false,
      marketing_consent_sms: client.marketing_consent_sms ?? false,
      marketing_consent_whatsapp: client.marketing_consent_whatsapp ?? false,
      notes: client.notes ?? "",
    });
  }, [client, form]);
